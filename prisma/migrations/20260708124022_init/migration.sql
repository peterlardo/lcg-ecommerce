-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'STOCK_MANAGER', 'DELIVERY_AGENT', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'READY', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'MOBILE_MONEY', 'CASH_ON_DELIVERY');
