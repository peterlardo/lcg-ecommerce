...
import { Bell, LogOut, Menu, Search, Settings, Store, Users } from "lucide-react"
  ...
  return (
    <header className="flex min-h-16 items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-6">
      <div className="flex items-center gap-2 sm:gap-3">
        {onMenuClick && (
          <button onClick={onMenuClick} className="rounded-lg p-2 text-gray-500 hover:bg-gray-100 md:hidden" aria-label="Menu">
      ...
      <div className="flex shrink-0 items-center gap-1 sm:gap-4">
        {canSee("utilisateurs") && <Link href="/admin/utilisateurs" className="flex items-center gap-2 rounded-lg px-2 sm:px-3 py-2 text-sm text-gray-600 transition-colors hover:bg-primary-50 hover:text-primary-700" title="Utilisateurs"><Users className="h-4 w-4" /><span className="hidden md:inline">Utilisateurs</span></Link>}
        {canSee("points-de-vente") && <Link href="/admin/points-de-vente" className="flex items-center gap-2 rounded-lg px-2 sm:px-3 py-2 text-sm text-gray-600 transition-colors hover:bg-primary-50 hover:text-primary-700" title="Points de vente"><Store className="h-4 w-4" /><span className="hidden md:inline">Points de vente</span></Link>}
        <Link href="/admin/parametres" className="flex items-center gap-2 rounded-lg px-2 sm:px-3 py-2 text-sm text-gray-600 transition-colors hover:bg-primary-50 hover:text-primary-700" title="Paramètres"><Settings className="h-4 w-4" /><span className="hidden md:inline">Paramètres</span></Link>
