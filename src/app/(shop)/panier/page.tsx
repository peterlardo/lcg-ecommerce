  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
        ...
        <p className="text-gray-500 mb-8">Découvrez nos produits et ajoutez vos premiers glaçons.</p>
        <Link
          href="/produits"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <Link
                  ...
                  className="font-semibold text-sm sm:text-base text-gray-900 hover:text-primary-600 line-clamp-1"
                >
                  {item.name}
                </Link>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-200 rounded-xl p-6 sticky top-24">
            ...
            <Link
              href="/commande"
              className="mt-6 w-full flex items-center justify-center gap-2 px-6 py-3 bg-primary-500 text-white font-semibold rounded-xl hover:bg-primary-600 transition-colors"
            >
