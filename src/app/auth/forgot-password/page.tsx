        ...
        <div className="flex flex-1 flex-col justify-center rounded-3xl bg-white/95 backdrop-blur-sm p-8 shadow-2xl shadow-black/20 sm:p-12 lg:p-16">
          ...
          {message ? (
            <div className="mx-auto w-full max-w-xl space-y-4">
              <div className="rounded-xl border border-green-200 bg-green-50 p-5 text-base text-green-700">
                {message}
              </div>
              <Link
                href="/auth/personnel"
                className="block w-full rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4 text-center text-lg font-semibold text-white shadow-md transition-all hover:from-gray-900 hover:to-black hover:shadow-lg"
              >
